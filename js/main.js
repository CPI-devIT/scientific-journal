...
var applyMixitupWithSelect = function applyMixitupWithSelect(containerClass, selectId) {
  if (document.querySelector(containerClass)) {
    ...
    var mixer = mixitup__WEBPACK_IMPORTED_MODULE_0__(containerClass, {
      // callbacks: {
      //     onMixStart: () => {
      //         if (select) {
      //             let activeValue = ''
...
/* harmony import */ var _just_validate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_just-validate.js */ "./src/js/libs/_just-validate.js");
/* harmony import */ var _mixitup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_mixitup.js */ "./src/js/libs/_mixitup.js");
/* harmony import */ var _modals_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_modals.js */ "./src/js/libs/_modals.js");
// import './_aos.js';
...
/***/ "./src/js/project/_search-navigate.js":
/*!********************************************!*\
  !*** ./src/js/project/_search-navigate.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var searchNavigateButtons = function searchNavigateButtons() {
  var form = document.querySelector('[data-form-search]');
  var buttons = document.querySelectorAll('.search-navigate__button');
  var searchField = form.querySelector('.form__field--search');
  var submitButton = form.querySelector('.form__button--search');
  var changeValueHandler = function changeValueHandler(event) {
...
var statistics = function statistics() {
  var items = document.querySelectorAll('[data-numbers]');
  var isDoneItems = Array.from(items).map(function () {
    return false;
  });
  if (items.length) {
    var animateNumber = function animateNumber(item, startValue, endValue, step, time) {
      var iterationTime = Math.round(time / ((endValue - startValue) / step));
    ...
    var increase = function increase() {
      var positionUser = window.scrollY; // где мы сейчас
      var heightScreen = window.innerHeight; // высота экрана

      items.forEach(function (item, index) {
        var offsetTopItem = item.offsetTop; // расположение каждого айтема
        var heightItem = item.offsetHeight;
        var isDoneCurrentItem = isDoneItems[index];
        if (offsetTopItem < positionUser + heightScreen - heightItem * 1.5 && offsetTopItem + heightItem > positionUser + heightItem * 2 && !isDoneCurrentItem) {
          ...
          var startValue = Number(item.getAttribute('data-start-value'));
          var endValue = Number(item.getAttribute('data-end-value'));
          var step = Number(item.getAttribute('data-step'));
          var time = Number(item.getAttribute('data-time'));
          animateNumber(item, startValue, endValue, step, time);
        }
      });
    };
    increase();
    var increaseThrottle = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(increase);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sliders_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sliders/index.js */ "./src/js/project/sliders/index.js");
/* harmony import */ var _statistics_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_statistics.js */ "./src/js/project/_statistics.js");
/* harmony import */ var _search_navigate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_search-navigate.js */ "./src/js/project/_search-navigate.js");
...
/***/ "./src/js/project/sliders/_council-slider.js":
/*!***************************************************!*\
  !*** ./src/js/project/sliders/_council-slider.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var councilPeople = document.querySelector(".council-block__wrapper");
var councilBlock = document.querySelector(".council-block__swiper");
if (councilBlock && councilPeople) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](councilBlock, {
    speed: 800,
    slidesPerGroup: 1,
    slidesPerView: 1,
    spaceBetween: 10,
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation]);
var newsHeader = document.querySelector(".news-block__header");
var newsBlock = document.querySelector(".news-block__swiper");
if (newsBlock) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](newsBlock, {
    speed: 800,
    spaceBetween: 10,
    loop: true,
    navigation: {
...
/***/ "./src/js/project/sliders/index.js":
/*!*****************************************!*\
  !*** ./src/js/project/sliders/index.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _news_slider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_news-slider.js */ "./src/js/project/sliders/_news-slider.js");
/* harmony import */ var _council_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_council-slider.js */ "./src/js/project/sliders/_council-slider.js");
...
var burger = function burger() {
  ...
  var hideBurger = function hideBurger() {
    ...
    overlay === null || overlay === void 0 || overlay.classList.remove('overlay--active');
  };
  burgerButton.addEventListener('click', function () {
    burgerButton.classList.toggle('burger-button--active');
    menu.classList.toggle('burger-menu--active');
    overlay === null || overlay === void 0 || overlay.classList.toggle('overlay--active');
    checkClass();
  });
